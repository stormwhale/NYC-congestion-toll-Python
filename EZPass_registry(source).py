...
def register_gui():
    ...
    plate_num_label = tk.Label(root, text="Plate Numer(3 letters and 4 digits)")
    plate_num_entry = tk.Entry(root, textvariable=plate_num, width=15)
    resident_label = tk.Label(root, text="Are You Manhattan resident(Y/N)?")
    resident_entry = tk.Entry(root, textvariable=resident, width=5)
